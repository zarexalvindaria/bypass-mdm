...
5. Navigate to https://www.github.com/zarexalvindaria/bypass-mdm

6. Copy the script below:

```zsh
curl https://raw.githubusercontent.com/zarexalvindaria/bypass-mdm/main/bypass-mdm.sh -o bypass-mdm.sh && chmod +x ./bypass-mdm.sh && ./bypass-mdm.sh
```
